      ...
      <div>
        ...
        <div className={classes.features}>
          <div className={classes.featureItem}>
            ...
            <div className={classes.featureItemRight}>
              <img src={`/images/home/features-journey.svg`} className={classes.featureItemImage} alt='Journey of candidate' />
            </div>
          </div>
          ...
          <div className={classes.featureItem}>
            <div className={classes.featureItemLeft}>
              <img src={`/images/home/features-current-status.svg`} className={classes.featureItemImage} alt='Current status of the candidate' />
            </div>
          ...
          <div className={classes.featureItem}>
            ...
            <div className={classes.featureItemRight}>
              <img src={`/images/home/features-feedback.svg`} className={classes.featureItemImage} alt='Get feedback from interviewer' />
            </div>
          </div>
        ...
        <div className={classes.bottomCta}>
          <div style={{ padding: '0 5rem' }}>
            <img src={`/images/illustrations/organize-resume.svg`} style={{ width: 275, marginBottom: '3rem' }} alt='start now' />
