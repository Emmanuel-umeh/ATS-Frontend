  ...
  return(
    <Fade in={true}>
      <div>
        {/* Meta tags */}
        <Helmet>
          <title>Privacy Policy - Blueportals</title>
        </Helmet>
        ...
        <div className={classes.content}>
          <p style={{ marginTop: 0 }}><strong>Blueportals</strong> ("us", "we", or "our") operates the https://Blueportals.app website (the "Service").</p>

          <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for Blueportals is powered by <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">FreePrivacyPolicy.com</a>.</p>

          <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://Blueportals.app</p>
          ...
          <Typography>Tracking & Cookies Data</Typography>
          ...
          <p>Blueportals uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>Blueportals will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

          <Typography variant="h5" gutterBottom>Disclosure Of Data</Typography>

          <Typography variant="h6">Legal Requirements</Typography>
          <p>Blueportals may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Blueportals</li>
          ...
          <ul>
            <li>By email: contact@Blueportals.com</li>
          </ul>
        </div>
      </div>
    </Fade>
