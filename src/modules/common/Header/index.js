          ...
          <Toolbar>
            ...
            <Typography variant={'h6'} color={'inherit'} className={classes.title}>
              <Link to={user.isAuthenticated ? routes.dashboard.path : routes.home.path}>
                { this.isNotHomePage() && <span>Blue<span className={classes.titleHighlight}>Portals</span></span> }
              </Link>
            </Typography>
          ...
          >
            {
              user.isAuthenticated
                ? <List
                    component={'nav'}
                    subheader={<ListSubheader component={'div'} style ={{
                      color : "white"
                    }}>Welcome { user.details.name }</ListSubheader>}
                  ...
                  >
                    <Link to={routes.dashboard.path}>
                      <ListItem button>
                        ...
                        <ListItemText primary={'Dashboard'} style ={{
                          color : "white"
                        }} />
 

                        <ListItemIcon children = {<ArrowBack style = {{color : "white", paddingLeft : 10}} />} ></ListItemIcon>
                      </ListItem>
                    </Link>
                    ...
                    <Link to={routes.candidate.path}>
                      <ListItem button>
                        ...
                        // secondary={'Manage all candidates'}
                        style ={{
                          color : "white"
                        }}
                         />
                    ...
                    <Link to={routes.interviewer.path}>
                      <ListItem button>
                        ...
                        // secondary={'Manage all interviewers'}
                        style ={{
                          color : "white"
                        }}
                         />
